   ...
   sReal *corre, sReal *corim, sReal *corfac )
{
   ...
   sReal a0i, a0r, a1i, a1r, a2i, a2r, a3i, a3r, arg, c, cl, cr, s, sl, sr, t; 
   sReal t2, t4, t6; 
   dReal cth, ctth, spth2, sth, sth4i, stth, th, th2, th4, tmth2, tth4i; 

   th = w*delta; 
   if ( a >= b || th < 0.0e0 || th > 3.1416e0 ) nrc_error ( "bad arguments to nrc_dftcor" ); 
   if ( fabs ( th ) < 5.0e-2 ) {
      t = th; 
      t2 = t*t; 
      t4 = t2*t2; 
