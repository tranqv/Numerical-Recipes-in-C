...
void nrc_pwtset ( int n )
{
   ...
   int k; 
   sReal sig = - 1.0; 
   static sReal c4[5]={0.0, 0.4829629131445341, 0.8365163037378079, 
         0.2241438680420134, - 0.1294095225512604}; 
   static sReal c12[13]={0.0, 0.111540743350, 0.494623890398, 0.751133908021, 
   ...
   static sReal c20[21]={0.0, 0.026670057901, 0.188176800078, 0.527201188932, 
   ...
   static sReal c4r[5], c12r[13], c20r[21]; 
   ...
   else nrc_error ( "unimplemented value n in nrc_pwtset" ); 
   for ( k = 1; k <= n; k ++ ) {
